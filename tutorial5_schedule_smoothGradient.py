...
def get_gradient(is_fast=False):
...
def get_timings():
    print "Smooth gradient, default schedule: \n"
    gradient = get_gradient()
    t1 = runAndMeasure(gradient, 800, 600)
    print ""
    print "Smooth gradient, fast: \n"
    gradient_fast = get_gradient(True)
    t2 = runAndMeasure(gradient_fast, 800, 600)
